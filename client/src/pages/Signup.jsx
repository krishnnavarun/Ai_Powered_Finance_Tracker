        ...
        <div className="relative z-10 w-full max-w-md rounded-[2rem] border border-slate-200/60 bg-white/70 p-6 sm:p-8 shadow-[0_24px_64px_rgba(15,23,42,0.06)] backdrop-blur-2xl text-slate-900">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input name="name" type="text" value={formData.name} onChange={handleChange} required className="w-full rounded-2xl border border-slate-200 bg-white/60 px-4 py-3 text-slate-900 placeholder-slate-400 outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100" />
            </div>
            <div>
            ...
            <div>
              ...
              <input name="confirmPassword" type="password" value={formData.confirmPassword} onChange={handleChange} required className="w-full rounded-2xl border border-slate-200 bg-white/60 px-4 py-3 text-slate-900 placeholder-slate-400 outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100" />
            </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link to="/login" className="font-semibold text-slate-900 underline decoration-sky-400 underline-offset-4 hover:text-slate-700">
              Login
            </Link>
          </p>
        </div>
