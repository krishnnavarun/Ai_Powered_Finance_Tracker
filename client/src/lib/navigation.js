...
export const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Wallets',
        icon: Wallet,
        description: 'Cash, bank, UPI and cards',
        checkpoint: 'CP9',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Subscriptions',
        icon: Repeat,
        description: 'Recurring charges found for you',
        checkpoint: 'CP20',
      },
    ],
  },
    ...
    items: [
      {
        ...
        label: 'Reports',
        icon: ChartColumn,
        description: 'Monthly and yearly breakdowns',
        checkpoint: 'CP12',
      },
      {
        path: '/insights',
        label: 'Insights',
        icon: Lightbulb,
        description: 'Alerts, forecasts and tips — with the reasons',
        checkpoint: 'CP20',
      },
      {
        path: '/assistant',
        ...
        icon: Sparkles,
        mobile: true,
        description: 'Ask anything about your money',
        checkpoint: 'CP22',
      },
    ],
  },
